...
- [x] **Phase 13: Backend Parity** — Algoritmos equivalentes ao WHOOP: Sleep Performance, Training State, Sleep Needed, Calorias (completed 2026-06-01)
...
- [x] 13-02-PLAN.md — sleep_performance_score() em sleep.py + integração em daily.py (ALG-10)
- [x] 13-03-PLAN.md — training_state_from_lookup() + sleep_needed() em daily.py (ALG-11, ALG-12)
- [x] 13-04-PLAN.md — rmr_kcal_per_day() + total_calories em daily.py + iOS stack completo (ALG-13)
